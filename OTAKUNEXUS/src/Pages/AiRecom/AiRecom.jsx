    ...
    return (
        <div className="max-w-7xl mx-auto p-4 lg:p-6">
            <div className="text-center mb-8">
                <h2 className="text-2xl lg:text-3xl font-bold text-white mb-4">Anime Recommendations</h2>
                <button 
                    onClick={getRecs} 
            ...
            <div className="space-y-6 lg:space-y-8">
                {recs.map(item => (
                    <div key={item.title} className="bg-gray-900 rounded-xl p-4 lg:p-6">
                        <h3 className="text-xl lg:text-2xl text-white font-bold mb-4">
