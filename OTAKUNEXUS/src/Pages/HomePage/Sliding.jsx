...
function Sliding() {
  ...
  return (
    <>
      <div className="flex relative bg-gradient-to-b from-black via-gray-800 to-gray-900 py-8">
        <div className="w-[90%] mx-auto">
          {filterList.length > 0 && (
            <div
              className="relative w-[100%] h-[50vh] flex items-center justify-between 
